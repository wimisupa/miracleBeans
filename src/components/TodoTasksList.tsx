    ...
    const fetchItems = async () => {
        ...
        try {
            ...
            if (Array.isArray(tasksData)) {
                ...
                // EARN tasks now skip TODO and go straight to PENDING, but just in case, filter them out here if they somehow show up.
                const myTodoTasks = tasksData.filter(t => (t.assigneeId || t.creatorId) === memberId && t.status === 'TODO' && !t.routineId && t.type !== 'EARN')
